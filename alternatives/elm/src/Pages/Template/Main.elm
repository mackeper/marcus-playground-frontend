module Pages.Template.Main exposing (Model, Msg, init, subscriptions, update, view)
    ...
    let
        ( page, pageCmds ) =
            case model.route of
                ...
                Route.JoinGame ->
                    JoinGame.init |> initTo JoinGame JoinGameMsg
...
view model =
    div []
        [ ul []
            ...
            , li [] [ a [ href "/boardgames/celebrities/game" ] [ text "Game" ] ]
            ]
        , viewPage model.page
        ]
